...
public sealed class NumberClipValueConverter : IMultiValueConverter
{
    public object Convert(object?[] values, Type targetType, object? parameter, CultureInfo culture)
    {
        ...
        var clipped = NumberFormatHelper.GetClippedValue(number, mode);
        return clipped.ToString("0.##", LocalizationManager.Instance.CurrentCulture);
    }
